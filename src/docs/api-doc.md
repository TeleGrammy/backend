...
> _EndPoint:_ **/resend-verification**
> _Request_Body_Example_:
> **{**
> **"email:** test@example.com,
> **}**
...
> _Request_Example:_
> **{**
> **"UUID":** test@example.com OR userName OR 01010101,
> **"password":** test123456
> **}**
...
> _EndPoint:_ **/reset-password/resend**
> _Request_Body_Example_:
> **{**
> **"email":** test@example.com
> **}**
...
> _EndPoint:_ **/reset-password/{token}**
> _Request_Body_Example_:
...
> _EndPoint:_ **/profile-picture?operation={value}**
> _HTTP_Method:_ **PATCH**
> **File Upload:**
...
> _Endpoint:_ **/profile-bio**
> _HTTP_Method:_ **PATCH**
> _Request_Body_Example:_
...
> _Endpoint:_ **/profile-screen-name**
> _HTTP_Method:_ **PATCH**
> _Request_Body_Example:_
...
> _Endpoint:_ **/story/:storyId**
> _HTTP_Method:_ **DELETE**

---
### Privacy Settings

> **🔏 Update Profile Privacy** - Update the user's privacy for fields that appears to other Telegram users.
> _Endpoint:_ **/profile-privacy?picture={first_value}&stories={second_value}&last-seen={third_value}**
> _HTTP_Method:_ **PATCH**
> _Request_Body_Example:_
